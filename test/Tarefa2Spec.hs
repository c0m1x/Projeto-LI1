...
gameMap3 :: Mapa 
gameMap3 = Mapa ((1,1), Oeste) (6,6) blocos3
blocos3 :: [[Bloco]]
blocos3 = [ [ Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio]
                , [ Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio]
                , [ Vazio, Vazio, Vazio, Plataforma, Plataforma, Plataforma, Plataforma, Vazio, Vazio, Vazio]
                , [ Vazio, Vazio, Vazio, Escada, Vazio, Vazio, Escada, Vazio, Vazio, Vazio]
                , [ Vazio, Vazio, Vazio, Escada, Vazio, Vazio, Escada, Vazio, Vazio, Vazio]
...
teste08 :: Test
teste08 = "T02: Jogo é válido porque tem chão completo" ~: True ~=? valida jogo01 {mapa = mapa02}