...
p10 = Personagem (0,0) Jogador (7,6) Oeste (1,1) False False 5 0 (False, 0.0)
p11 = Personagem (0,0) Jogador (7,5) Oeste (1,1) False False 5 0 (False, 0.0)  

teste8 = "T8: Jogadores colidem " ~: True ~=? colisoesPersonagens p1 p2

teste9 = "T9: Jogador não colide com limites laterais" ~: True ~=? colisoesParede gameMap2 p10


gameMap2 :: Mapa 
gameMap2 = Mapa ((1,1), Oeste) (6,6) blocos2
blocos2 :: [[Bloco]]
